...
import { IEducationalContentService } from '../finmentor.types';
...
export class EducationalContentController {
  ...
  public getModuleById = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      console.error(`Error in EducationalContentController.getModuleById(${req.params.id}):`, error);
  ...
  public getModulesByCategory = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      console.error(`Error in EducationalContentController.getModulesByCategory(${req.params.category}):`, error);
  ...
  public getModulesByWebType = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      console.error(`Error in EducationalContentController.getModulesByWebType(${req.params.webType}):`, error);
  ...
  public getModulesByDifficulty = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      console.error(`Error in EducationalContentController.getModulesByDifficulty(${req.params.difficulty}):`, error);
  ...
  public getTermsByCategory = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      console.error(`Error in EducationalContentController.getTermsByCategory(${req.params.category}):`, error);
  ...
  public getTermsByWebType = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      console.error(`Error in EducationalContentController.getTermsByWebType(${req.params.webType}):`, error);
